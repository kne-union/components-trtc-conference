const locale = {
  ...
  TwoHours: '2 hours',
  ThreeHours: '3 hours',
  AllowExtend: 'Allow Host to Extend Meeting',
  AllowExtendTips: 'When enabled, the host can extend the meeting by 15 minutes when less than 15 minutes remain',
  ...
  DocumentTypeIframe: 'Embedded Page',
  DocumentUrl: 'Embedded Page URL',
