...
const Layout = createWithRemoteLoader({
  ...
  withLocale(
    ({ className, remoteModules, name, signalLevel, startTime, duration, toolbar, children, isMobile: isMobileProp, headerExtra, onBack }) => {
            ...
            <Flex className={style['header']} justify="space-between" align="center">
              <Flex align="center" justify="space-between" gap={8} className={style['mobile-title-row']}>
                <Flex align="center" gap={8} className={style['mobile-name-wrap']}>
                  {onBack ? (
                    <Button type="link" size="small" className={style['back-button']} icon={<Icon type="icon-arrow-thin-left" />} onClick={onBack}>
                ...
                <Button
                  ...
                  onClick={() => {
                    modal({
                      ...
                      children: ({ childrenRef }) => <LayoutType ref={childrenRef} defaultValue={setting.layoutType} isMobile={isMobile} />,
